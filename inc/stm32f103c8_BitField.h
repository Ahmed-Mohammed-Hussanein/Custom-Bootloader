...
#define I2C_CCR_F_S                         I2C_CCR_F_S_Msk                    /*!< I2C master mode selection */

/*******************  Bit definition for I2C_TRISE register  ********************/
#define I2C_TRISE_TRISE_Pos					(0U)
#define I2C_TRISE_TRISE_Msk					(0x3FUL << I2C_TRISE_TRISE_Pos)		/*!< 0x0000003F */
#define I2C_TRISE_TRISE						I2C_TRISE_TRISE_Msk					/*!< Maximum rise time in Fm/Sm mode (Master mode) */
...
#define CRC_CR_RESET						CRC_CR_RESET_Msk					/*!< Resets the CRC calculation unit */
